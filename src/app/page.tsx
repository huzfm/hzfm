...
`}
      ...
      <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-50">
        <div
          className={`flex items-center justify-between gap-4 backdrop-blur-lg border rounded-2xl px-4 py-3 shadow-2xl ${
            isDark
        ...
        >
          ...
          <a className="relative top-[11px]">
            <ThemeToggle /> {/* Aligned on the right */}
          </a>
        </div>
      </div>
    </>
